...
<div class="main">
  ...
  <div class="main-content">
    <div class="container-fluid">
      <h3 class="page-title">Clientes</h3><button type="button" role="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#addAdm"><i class="fa fa-plus"></i> Add Adm</button>
      <div class="row">
        <div class="col-md-12">
<div class="panel">
